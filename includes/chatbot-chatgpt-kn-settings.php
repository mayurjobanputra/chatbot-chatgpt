...
function chatbot_chatgpt_knowledge_navigator_section_callback($args) {
    ...
    <div class="wrap">
        ...
        <p><b><i>When you are ready to scan you website, set the 'Run Schedule' to 'Now', then click 'Save Settings'. You will see Status updated to 'In Process' if everything is setup correctly (your WP cron function). Wait a few minutes and then refresh the page and you should see status change to 'Completed on...'.</i></b></p>
